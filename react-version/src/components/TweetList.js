    ...
    <section className="tweets">
      ...
      <article className="tweet">
        <header className="tweet--header">
          <img className="tweet--avatar" src="https://i.imgur.com/73hZDYK.png" alt="User avatar" />
        ...
        <footer className="tweet--footer">
          <small className="footer--age">10 days ago
            <small>
      ...
      <article className="tweet">
        <header className="tweet--header">
          <img className="tweet--avatar" src="https://i.imgur.com/nlhLi3I.png" alt="User avatar" />
